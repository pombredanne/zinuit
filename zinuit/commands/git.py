...
from zinuit.app import get_repo_dir, get_apps, get_remote
from zinuit.utils import set_git_remote_url
...
def remote_reset_url(app):
	"Reset app remote url to metel official"
	git_url = "https://github.com/amonak/{}.git".format(app)
	set_git_remote_url(git_url)
